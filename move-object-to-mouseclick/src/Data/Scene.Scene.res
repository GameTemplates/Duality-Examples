<root dataType="Struct" type="Duality.Resources.Scene" id="129723834">
  ...
  <serializeObj dataType="Array" type="Duality.GameObject[]" id="427169525">
    ...
    <item dataType="Struct" type="Duality.GameObject" id="4246370855">
      <active dataType="Bool">true</active>
      <children />
      <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="2178096517">
        <_items dataType="Array" type="Duality.Component[]" id="1293021526">
          <item dataType="Struct" type="Duality.Components.Transform" id="8680777">
            <active dataType="Bool">true</active>
            <angle dataType="Float">0</angle>
            <angleAbs dataType="Float">0</angleAbs>
            <angleVel dataType="Float">0</angleVel>
            <angleVelAbs dataType="Float">0</angleVelAbs>
            <deriveAngle dataType="Bool">true</deriveAngle>
            <gameobj dataType="ObjectRef">4246370855</gameobj>
            <ignoreParent dataType="Bool">false</ignoreParent>
            <parentTransform />
            <pos dataType="Struct" type="Duality.Vector3">
          ...
          <item dataType="Struct" type="Duality.Components.Renderers.SpriteRenderer" id="1420022839">
            <active dataType="Bool">true</active>
          ...
          <item dataType="Struct" type="Movement.MoveTowardMouseClick" id="2044564587">
            <_x003C_canMove_x003E_k__BackingField dataType="Bool">false</_x003C_canMove_x003E_k__BackingField>
            <_x003C_clickPos_x003E_k__BackingField dataType="Struct" type="Duality.Vector3" />
            <_x003C_MovementSpeed_x003E_k__BackingField dataType="Float">1</_x003C_MovementSpeed_x003E_k__BackingField>
            <_x003C_objectPos_x003E_k__BackingField dataType="Struct" type="Duality.Vector3" />
            <active dataType="Bool">true</active>
            <gameobj dataType="ObjectRef">4246370855</gameobj>
          </item>
          <item dataType="Struct" type="Rotation.RotateTowardMouseClick" id="609687842">
            <_x003C_canRotate_x003E_k__BackingField dataType="Bool">false</_x003C_canRotate_x003E_k__BackingField>
            <_x003C_clickX_x003E_k__BackingField dataType="Float">0</_x003C_clickX_x003E_k__BackingField>
            <_x003C_clickY_x003E_k__BackingField dataType="Float">0</_x003C_clickY_x003E_k__BackingField>
            <_x003C_objectPos_x003E_k__BackingField dataType="Struct" type="Duality.Vector3" />
            <_x003C_RotationSpeed_x003E_k__BackingField dataType="Float">0.15</_x003C_RotationSpeed_x003E_k__BackingField>
            <active dataType="Bool">true</active>
            <gameobj dataType="ObjectRef">4246370855</gameobj>
          </item>
        </_items>
      ...
      <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="1273273000" surrogate="true">
        <header />
        <body>
          <keys dataType="Array" type="System.Object[]" id="3112948847">
            <item dataType="ObjectRef">3767936068</item>
            <item dataType="Type" id="2431613422" value="Duality.Components.Renderers.SpriteRenderer" />
            <item dataType="Type" id="3570091978" value="Rotation.RotateTowardMouseClick" />
            <item dataType="Type" id="2887948766" value="Movement.MoveTowardMouseClick" />
          </keys>
          <values dataType="Array" type="System.Object[]" id="4157695648">
            <item dataType="ObjectRef">8680777</item>
            <item dataType="ObjectRef">1420022839</item>
            <item dataType="ObjectRef">609687842</item>
            <item dataType="ObjectRef">2044564587</item>
          </values>
        </body>
      </compMap>
      <compTransform dataType="ObjectRef">8680777</compTransform>
      <identifier dataType="Struct" type="System.Guid" surrogate="true">
        <header>
          <data dataType="Array" type="System.Byte[]" id="1713142269">Qdz+5FwLzUKtH/pp6uaWAQ==</data>
        </header>
        <body />
      </identifier>
      <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
        ...
        <_items dataType="Array" type="Duality.Component[]" id="3729068496" length="4">
          ...
          <item dataType="Struct" type="Duality.Components.Renderers.TextRenderer" id="3073279122">
            ...
            <text dataType="Struct" type="Duality.Drawing.FormattedText" id="2684189450">
              ...
              <sourceText dataType="String">Click left mouse button to rotate and move the object toward the position of the click</sourceText>
